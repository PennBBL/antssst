...
docker run --rm -ti --entrypoint="/bin/sh" \
  ...
  -v /Users/butellyn/Documents/ExtraLong/data/singleSubjectTemplates/antssst4:/data/output \
  pennbbl/antssst:0.0.4 /scripts/run.sh ses-CONTE1 ses-NODRA1 ses-ONM1 ses-PNC1 ses-PNC2
